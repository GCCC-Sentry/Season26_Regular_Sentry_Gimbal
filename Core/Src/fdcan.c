...
void MX_FDCAN1_Init(void)
{
  ...
  hfdcan1.Init.ExtFiltersNbr = 2; // Increase limit too
...
void MX_FDCAN2_Init(void)
{
  ...
  hfdcan2.Init.ExtFiltersNbr = 2; // Increase limit too
...
void MX_FDCAN3_Init(void)
{
  ...
  hfdcan3.Init.ExtFiltersNbr = 2; // Increase this to allow Ext filters
